...
Из теоретического материала можно сделать вывод, что основная разница между SPA и Module Federation в том, что SPA может использовать разные фреймворки для каждого модуля, а такой необходимости у нас нет. Следовательно, наш выбор - Module Federation.
...
*Микрофронты*
```
/host // 8080 // корневой модуль
	/src
		App.js

/auth // 8081 // все что связано с авторизацией -> классика
	/src
		/components
			Login.js
			Register.js
...
/mainPage // 8082 // главная страница (авторизованная зона) -> проще для написанного api, App, проще тестировать, вносить изменения
	/src
		/components
			Main.js
			Card.js
...
/popups // 8083 // все попапы -> один шаблон, одни стили
	/src
		/components
			PopupWithForm.js
			EditProfilePopup.js
...
/prelogin // 8084 // все что до авторизации (зона прелогина) -> проще вносить изменения, тестировать
	/src
		/components
			ProtectedRoute.js
			Header.js
...
ЗАДАНИЕ 2: файл в проекте "спринт1-2"